...
export const PaginationPageDefault = ({ rounded, page = 1, total = 10, className, ...props }: PaginationProps) => {
    ...
    return (
        <Pagination.Root
            ...
            page={page}
            total={total}
            className={cx("flex w-full items-center justify-between gap-3 border-t border-secondary pt-2 md:pt-3", className)}
        >
            <div className="hidden flex-1 justify-start items-center md:flex pl-4">
            ...
            <div className="hidden flex-1 justify-end items-center md:flex pr-4">
