                ...
                return (
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="text-center mb-8">
                            <h2 className="text-2xl font-bold text-primary mb-4">Fund Analytics Dashboard</h2>
                            <p className="text-lg text-secondary max-w-2xl mx-auto">
                                Analyze fund performance, review AI recommendations, and optimize your assessment processes.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            >
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-secondary">Review AI suggestions for fund optimization</p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow cursor-pointer opacity-50">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-secondary">Fund performance metrics and trends</p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow cursor-pointer opacity-50">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-primary">Application Insights</h3>
                                        <p className="text-sm text-secondary">Application quality and assessment insights</p>
                                    </div>
                                </div>
                                <Button size="sm" color="secondary" className="w-full" isDisabled>
                                    Coming Soon
                        ...
                        <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                            ...
                            <p className="text-sm text-blue-800">
                                Our analytics platform helps you optimize your funding programs through data-driven insights. 
                                Currently featuring AI recommendations, with performance analytics, application insights, and 
                ...
                <div className="px-4 lg:px-8">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-1 text-center">
                            <p className="text-md font-semibold text-tertiary">Fund Management</p>
