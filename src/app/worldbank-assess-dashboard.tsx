...
export const WorldBankAssessDashboard = () => {
    ...
    useEffect(() => {
        fetch('/api/worldbank-assessments')
        ...
        try {
            const transformed = assessments.map((assessment, index) => {
                ...
                if (!assessment || typeof assessment !== 'object') {
                    console.error(`❌ WorldBankAssessDashboard: Invalid assessment at index ${index}:`, assessment);
                ...
                for (const field of requiredFields) {
                    if (!(field in assessment)) {
                        console.error(`❌ WorldBankAssessDashboard: Missing required field '${field}' in assessment:`, assessment);
                ...
                const result = {
                    ...
                    projectName: assessment.fund.name,
                    assessmentType: assessment.assessmentType,
                };
            ...
            console.error('❌ WorldBankAssessDashboard: Error during transformation:', transformError);
                        ...
                        {mounted && sortedItems && sortedItems.length > 0 && !assessmentsLoading ? (
                            ...
                            >
                                <Table.Header className="bg-primary">
                                    ...
                                    <Table.Head id="categories" label="Project" />
                                    ...
                                    <Table.Row id={movement.id} highlightSelectedRow={false}>
                                        ...
                                        <Table.Cell>
                                            <div className="flex gap-1">
                                                ...
                                                >
                                                    {(movement as any).projectName || "Government Project"}
                                                </BadgeWithDot>
                                            </div>
                                        </Table.Cell>
                                                    ...
                                                    <>
                                                        ...
                                                        {transformedAssessments.length > 0 && (
                                                            <ButtonUtility
                                                                ...
                                                                icon={Eye}
                                                                onClick={() => router.push(`/worldbank/assess/${movement.id}`)}
                                                            />
                                                        )}
