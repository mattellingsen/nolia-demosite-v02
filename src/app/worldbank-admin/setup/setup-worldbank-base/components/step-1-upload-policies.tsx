...
export const Step1UploadPolicies: React.FC<Step1Props> = ({
    ...
    const checkBaseNameAvailability = useCallback(async (name: string) => {
        ...
        try {
            const response = await fetch(`/api/worldbank-base/check-name?name=${encodeURIComponent(name.trim())}`);
    ...
    return (
        <div className="flex flex-col gap-8">
                ...
                <div>
                    ...
                    <div className="relative">
                        <InputBase
                            ...
                            placeholder="e.g., Corporate World Bank Standards 2025"
            ...
            <div>
                ...
                <p className="text-sm text-tertiary mb-4">
                    Upload your organisation's global World Bank documents. These will define the standard operating procedures for all World Bank activities.
                </p>
