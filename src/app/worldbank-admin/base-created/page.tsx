...
function BaseCreatedContent() {
    ...
    const fetchJobStatus = async () => {
        ...
        try {
            const response = await fetch(`/api/worldbank-base/${baseId}/job-status`);
                ...
                <div className="px-4 lg:px-8">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-1">
                            <p className="text-md font-semibold text-tertiary">World Bank Base</p>
                ...
                <div className="px-4 lg:px-8">
                    <div className="grid gap-6 lg:grid-cols-3">
                                ...
                                <div className="flex items-start justify-between mb-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-tertiary mt-1">
                                            Building your World Bank knowledge base
                                        </p>
                                    </div>
                        ...
                        <div className="space-y-6">
                            {/* Edit Configuration */}
                            <Button
                                href={`/worldbank-admin/setup/setup-worldbank-base?edit=${baseId}`}
                                iconLeading={Edit05}
                                color="primary"
                                size="md"
                                className="w-full"
                            ...
                            <div className="rounded-lg bg-gray-50 p-4">
                                ...
                                <p className="text-xs text-tertiary mb-3">
                                    Learn more about configuring World Bank standards
                                </p>
