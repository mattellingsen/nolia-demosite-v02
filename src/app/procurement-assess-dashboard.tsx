...
export const ProcurementAssessDashboard = () => {
    ...
    useEffect(() => {
        fetch('/api/procurement-assessments')
        ...
        try {
            const transformed = assessments.map((assessment, index) => {
                ...
                if (!assessment || typeof assessment !== 'object') {
                    console.error(`❌ ProcurementAssessDashboard: Invalid assessment at index ${index}:`, assessment);
                ...
                for (const field of requiredFields) {
                    if (!(field in assessment)) {
                        console.error(`❌ ProcurementAssessDashboard: Missing required field '${field}' in assessment:`, assessment);
                ...
                const result = {
                    ...
                    tenderName: assessment.fund.name,
                    assessmentType: assessment.assessmentType,
                };
            ...
            console.error('❌ ProcurementAssessDashboard: Error during transformation:', transformError);
            ...
            <main className="flex min-w-0 flex-1 flex-col gap-8 pt-8 pb-12">
                <div className="flex flex-col flex-wrap items-start justify-between gap-x-4 gap-y-5 px-4 lg:flex-row lg:px-8">
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-3">
                            <p className="text-display-md font-semibold text-primary">Submission Assessment</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-6 px-4 lg:px-8">
                    <div className="flex flex-col flex-wrap justify-between gap-x-4 gap-y-6 lg:flex-row lg:items-center">
                        <p className="text-lg font-semibold text-primary">Submissions received</p>
                        ...
                        {mounted && sortedItems && sortedItems.length > 0 && !assessmentsLoading ? (
                            ...
                            >
                                <Table.Header className="bg-primary">
                                    ...
                                    <Table.Head id="categories" label="Tender" />
                                    ...
                                    <Table.Row id={movement.id} highlightSelectedRow={false}>
                                        ...
                                        <Table.Cell>
                                            <div className="flex gap-1">
                                                ...
                                                >
                                                    {(movement as any).tenderName || "Government Tender"}
                                                </BadgeWithDot>
                                            </div>
                                        </Table.Cell>
                                                    ...
                                                    <>
                                                        ...
                                                        {transformedAssessments.length > 0 && (
                                                            <ButtonUtility
                                                                ...
                                                                icon={Eye}
                                                                onClick={() => router.push(`/procurement/assess/${movement.id}`)}
                                                            />
                                                        )}
                            ...
                            <div className="p-8 text-center text-tertiary">
                                ...
                                <p className="text-sm">Upload and assess submissions to see them here</p>
                            </div>
                        ) : (
