    ...
    return (
        <div className="flex flex-col bg-primary lg:flex-row">
            ...
            <main className="flex min-w-0 flex-1 flex-col gap-8 pt-8 pb-12 px-4 lg:px-8">
                ...
                {/* Performance Chart */}
                <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
                    <h2 className="text-lg font-semibold text-primary mb-4">Tender Performance Projection</h2>
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h4 className="text-sm font-medium text-primary">Test Your Tender</h4>
                                <p className="text-sm text-secondary">
                                    Upload sample submissions to validate your AI assessment system.
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
