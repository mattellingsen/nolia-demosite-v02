        ...
        try {
            ...
            const mockSuggestions: AISuggestion[] = [
                ...
                },
                {
                    ...
                    description: 'Provide instant feedback to tenderers as they complete sections.',
                    impact: 'high',
                    suggestedValue: 'AI-powered completion tips and quality scores',
                    reasoning: 'This will help tenderers submit higher-quality submissions, reducing your assessment workload.',
                    accepted: false
                }
            ];
            ...
            const mockAnalysis: AnalysisData = {
                ...
                improvements: [
                    ...
                    'Include guidance text to help tenderers'
                ],
                processingTime: 2800
            };
            ...
            {(!formData || !formData.applicationForm) && (
                <div className="text-center py-12 space-y-6">
                    <div className="bg-blue-50 rounded-lg p-8 border border-blue-200">
                        <h3 className="text-lg font-semibold text-blue-900 mb-4">No Tender Data Available</h3>
                        <p className="text-sm text-blue-800 mb-6">
                            To generate AI recommendations, you need to complete the tender setup process first.
                            This includes uploading your submission form, selection criteria, output templates, and good examples.
                        </p>
                        <Button 
                            size="lg" 
                            color="primary" 
                            href="/procurement/setup/setup-new-tender"
                        >
                            Set up a New Tender
                        </Button>
                    </div>
