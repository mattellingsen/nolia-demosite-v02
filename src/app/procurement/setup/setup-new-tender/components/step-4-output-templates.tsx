...
export const Step4OutputTemplates: React.FC<Step4Props> = ({
    ...
    // Note: The actual tender creation is handled by the parent component's onNext function
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="text-center mb-6">
                <p className="text-lg text-secondary max-w-2xl mx-auto">
                    Upload output templates that define how tender evaluation results should be formatted and presented.
                </p>
            </div>
