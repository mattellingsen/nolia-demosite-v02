        ...
        try {
            ...
            const mockSuggestions: AISuggestion[] = [
                {
                    ...
                    description: 'Based on your selection criteria, the current weighting might not effectively differentiate between applicants.',
                    impact: 'high',
                ...
                },
                {
                    ...
                    description: 'Include pre-qualification questions to filter out ineligible applications early.',
                    impact: 'medium',
                    suggestedValue: 'Add 3-4 yes/no eligibility questions at the start',
                    reasoning: 'This will reduce processing time for applications that don\'t meet basic criteria.',
                    accepted: false
                },
                {
                    id: '3',
                ...
                },
                {
                    ...
                    reasoning: 'This will help applicants submit higher-quality applications, reducing your assessment workload.',
                    accepted: false
                }
            ];
            ...
            const mockAnalysis: AnalysisData = {
                ...
                strengths: [
                    ...
                    'Comprehensive application form structure',
                ...
                improvements: [
                    ...
                    'Add real-time validation to improve application quality',
            ...
            <div className="text-center space-y-4">
                <div>
                    ...
                    <p className="text-lg text-secondary max-w-2xl mx-auto">
                        ...
                        for optimizing your application process.
                    </p>
                </div>
            </div>
            ...
            {analysis && (
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    <p className="text-sm text-blue-800">
                        ...
                        These optimizations will be applied to your AI application form in the next step.
                    </p>
                </div>
            )}
        </div>
