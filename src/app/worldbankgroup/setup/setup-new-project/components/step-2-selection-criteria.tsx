                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-success-800">
                                RFx Document{formData.selectionCriteria.length !== 1 ? 's' : ''} Ready for Upload
                            </h3>
                            <p className="text-sm text-success-600">
                                {formData.selectionCriteria.length} document{formData.selectionCriteria.length !== 1 ? 's' : ''} ready for upload. These will be processed when your project is created.
                            </p>
                        </div>
                    </div>
                </div>
