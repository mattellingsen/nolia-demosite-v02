        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex justify-center">
                <div className="w-full max-w-2xl">
                    <FileUpload.Root>
                        <FileUpload.DropZone
                            hint="PDF, Word, Excel documents, or text files up to 10MB each"
                            ...
                            onDropUnacceptedFiles={(files) => {
                                setUploadError('Please upload PDF, Word, Excel document, or text files.');
                            }}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-success-800">
                                Output Template{formData.outputTemplates.length !== 1 ? 's' : ''} Ready for Upload
                            </h3>
                            <p className="text-sm text-success-600">
                                {formData.outputTemplates.length} template{formData.outputTemplates.length !== 1 ? 's' : ''} ready for upload. These will be processed when your project is created.
                            </p>
                        </div>
                    </div>
                </div>
