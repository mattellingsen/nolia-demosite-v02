                ...
                return (
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="text-center mb-8">
                            <h2 className="text-2xl font-bold text-primary mb-4">Project Analytics Dashboard</h2>
                            <p className="text-lg text-secondary max-w-2xl mx-auto">
                                Analyze project performance, review AI recommendations, and optimize your assessment processes.
                            </p>
                        </div>
                            ...
                            >
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-secondary">Review AI suggestions for project optimization</p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow cursor-pointer opacity-50">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-secondary">Project performance metrics and trends</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                            ...
                            <p className="text-sm text-blue-800">
                                Our analytics platform helps you optimize your World Bank projects through data-driven insights.
                ...
                <div className="px-4 lg:px-8">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-1 text-center">
                            <p className="text-md font-semibold text-tertiary">Project Management</p>
